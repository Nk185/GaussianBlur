...
namespace GaussianBlur
{
    ...
    class GaussianBlur
    {
        ...
        public static Thread tt2;
        public static Thread tt3;
        ...
        Again:
            ...
            if (openDlg.ShowDialog() == DialogResult.OK)
            {
               ...
               // Stopwatch StopWatch        = Stopwatch.StartNew();
                ...
                ProcessRedH(ref rgbValues2D, ref GD, blurRect);
                Console.WriteLine(">DONE................[16 %]");
                ProcessGreenH(ref rgbValues2D, ref GD, blurRect);
                Console.WriteLine(">DONE................[32 %]");
                ProcessBlueH(ref rgbValues2D, ref GD, blurRect);
                Console.WriteLine(">DONE................[47 %]");

                ProcessRedV(ref rgbValues2D, ref GD, blurRect);
                Console.WriteLine(">DONE................[63 %]");
                ProcessGreenV(ref rgbValues2D, ref GD, blurRect);
                Console.WriteLine(">DONE................[79 %]");
                ProcessBlueV(ref rgbValues2D, ref GD, blurRect);
               ...
               /* Marshal.Copy(ConvertToSingle(rgbValues2D, bmp.Height, bmp.Width, bmpData.Stride), 0, bmpData.Scan0, Math.Abs(bmpData.Height * bmpData.Stride));
                ...
                tt = new Thread(() => tryt(rgbValues2D, GD, blurRect, bmp, bmpData, outputFilepath));
                tt2 = new Thread(() => tryt2(rgbValues2D, GD, blurRect, bmp, bmpData, outputFilepath));
                tt3 = new Thread(() => tryt3(rgbValues2D, GD, blurRect, bmp, bmpData, outputFilepath));
                tt.Start();
                tt2.Start();
                tt3.Start();
        ...
        public static void tryt(ColorStructure rgbValues2D, GaussianDistribution GD, Rectangle blurRect, Bitmap bmp, BitmapData bmpData, string outputFilepath)
        {
            ProcessRedH(ref rgbValues2D, ref GD, blurRect);
            ProcessRedV(ref rgbValues2D, ref GD, blurRect);
            jj++;
            check(rgbValues2D, bmp, bmpData, outputFilepath);
            tt.Abort();
        }
        public static void tryt2(ColorStructure rgbValues2D, GaussianDistribution GD, Rectangle blurRect, Bitmap bmp, BitmapData bmpData, string outputFilepath)
        {
            ProcessGreenH(ref rgbValues2D, ref GD, blurRect);
            ProcessGreenV(ref rgbValues2D, ref GD, blurRect);
            jj++;
        ...
        public static void tryt3(ColorStructure rgbValues2D, GaussianDistribution GD, Rectangle blurRect, Bitmap bmp, BitmapData bmpData, string outputFilepath)
        {
            ProcessBlueH(ref rgbValues2D, ref GD, blurRect);
            ProcessBlueV(ref rgbValues2D, ref GD, blurRect);
            jj++;
        ...
        public static void check(ColorStructure rgbValues2D, Bitmap bmp, BitmapData bmpData, string outputFilepath)
        {
            if (jj == 3)
            {
                Console.WriteLine("Done.............[100 %]");
                ...
                Console.WriteLine("Done.............[{0} %]", (100 * jj)/3);
        }

        // [B G R] instead of [R G B]
        public static void ProcessRedH(ref ColorStructure rgbValues, ref GaussianDistribution gd, Rectangle blurRect)
        {
            #region Left -> Right
        ...
        public static void ProcessRedV(ref ColorStructure rgbValues, ref GaussianDistribution gd, Rectangle blurRect)
        {
            #region Up -> Down
            for (int j = blurRect.X; j <= blurRect.X + blurRect.Width; j++)
            {
        ...
        public static void ProcessGreenH(ref ColorStructure rgbValues, ref GaussianDistribution gd, Rectangle blurRect)
        {
            #region Left -> Right
            for (int i = blurRect.Y; i <= blurRect.Y + blurRect.Height; i++)
            {
        ...
        public static void ProcessGreenV(ref ColorStructure rgbValues, ref GaussianDistribution gd, Rectangle blurRect)
        {
            #region Up -> Down
            for (int j = blurRect.X; j <= blurRect.X + blurRect.Width; j++)
            {
        ...
        public static void ProcessBlueH(ref ColorStructure rgbValues, ref GaussianDistribution gd, Rectangle blurRect)
        {
            #region Left -> Right
            for (int i = blurRect.Y; i <= blurRect.Y + blurRect.Height; i++)
            {
        ...
        public static void ProcessBlueV(ref ColorStructure rgbValues, ref GaussianDistribution gd, Rectangle blurRect)
        {
            #region Up -> Down
            for (int j = blurRect.X; j <= blurRect.X + blurRect.Width; j++)
            {
